...
insert into donations (user_id, donation_date, Status) values(1, '2-13-2022', 'Pick-Up');
insert into donations (user_id, donation_date, Status) values(1, '2-13-2022', 'Pick-Up');
...
insert into donation_Items (donation_id, name, food_type, description, image, freshness, quantity, leftover) 
                     values(2, 'Pizza', 'Cooked', 'A few slices of pizza', 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Eq_it-na_pizza-margherita_sep2005_sml.jpg', '72', 5, 3);
insert into donation_Items (donation_id, name, food_type, description, image, freshness, quantity, leftover) 
                     values(3, 'Pizza', 'Cooked', 'A few slices of pizza', 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Eq_it-na_pizza-margherita_sep2005_sml.jpg', '72', 5, 3);

insert into donation_Items (donation_id, name, food_type, description, image, freshness, quantity, leftover) 
                     values(4, 'Pasta', 'Cooked', '10lbs of Pasta', 'https://upload.wikimedia.org/wikipedia/commons/d/dc/The_Only_Original_Alfredo_Sauce_with_Butter_and_Parmesano-Reggiano_Cheese.png', '72', 10, 8);
insert into donation_Items (donation_id, name, food_type, description, image, freshness, quantity, leftover) 
...
insert into reservations (user_id, reservation_date, status) values (2, '2-13-2022', 'Waiting');
insert into reservations (user_id, reservation_date, status) values (2, '2-13-2022', 'Waiting');
